...
class banglaBlogController extends Controller
{
    public function index()
    {
        ...
        return view('FrontendBangla.blog.index', compact('blog_categories' , 'blog_posts'));
    ...
    {
        $blog_posts = BlogPost::where('blog_category_id', $id)->orderBy('updated_at','DESC')->paginate(6);
    ...
    public function getPostById($slug_en)
    {
        ...
        return view('FrontendBangla.blog.bangla_blog_post_by_postid', compact('blog_categories', 'blog_post' ,'blog_related_posts' , 'blog_comments', 'previous', 'next'));
    ...
    public function blogPostPdfDownload($id)
    {
        ...
        $mpdf->WriteHTML(view('FrontendBangla.blog.print', compact('blog_post')));
