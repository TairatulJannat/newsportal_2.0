                                ...
                                @if($key == 0)
                                    ...
                                    <div class="details">
                                        ...
                                        <div class="news-details">
                                            <p>{!! Str::limit( $blog_post->description_en , 200 )!!} </p>
                                        </div>
                                    ...
                                    <ul class="newscategory-menu">
                                        @foreach($blog_categories as $blog_category)
                                            @if($blog_category->status==1)
                                                <li><a href="{{ route('frontend.blog.postBycategoryId' , $blog_category->id) }}" data-slug_bn="{{ $blog_category->blog_category_slug_en }}" data-id="{{ $blog_category->id }}" class="blog-post-by-category">{{$blog_category->blog_category_name_en}}</a></li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </div>
                                ...
                                <li>
                                    <div class="blog-list-item">
                                        ...
                                        <div class="details">
                                            ...
                                            <div class="news-details">
                                                <p>{!! Str::limit( $blog_post->description_en , 300 )!!}<a href="{{route('frontend.blog.postById' , [ 'slug_en' =>  $blog_post->slug_en] ) }}" class="allnewscate-read">Read More <i class="fa fa-angle-right"></i></a></p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
