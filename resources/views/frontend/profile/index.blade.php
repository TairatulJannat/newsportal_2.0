    ...
    <div class="container">
        ...
        <div class="bg-white shadow rounded-lg d-block d-sm-flex">
            ...
            <div class="profile-tab-nav border-right">
                <form action="{{ route('frontend.user.profile', $user->id ) }}" id="updatebutton" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
            ...
            <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 edit_subdistrict">
                            <label><b>Subdistrict</b></label>  
                            <select value="0"  class="form-control sendbutton" data-style="select-with-transition" title="Choose SubCategory" id="sub_district_id" name="subdistrict" >
                                ...
                                @foreach($subdistrict as $data)
                                    @if($data->id == $user->city)
                                        <option style="background-color: black; color:white" value="{{ $data->id }}" selected> {{ $data->subdistrict_name_en }} </option>
                                    @endif
                                        <option  style="background-color: black; color:white" value="{{ $data->id }}"> {{ $data->subdistrict_name_en }} </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <form action="{{ route('frontend.user.changepassword',$user->id) }}" method="post" > 
                @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
