        ...
        @if($key == 0)
            <div class="news-highlighted d-flex">
                ...
                <div class="details">
                    ...
                    <p>{!! Str::limit($post->details_en , 200) !!}</p> <a href="{{route('frontend.post.categorypostbyId' , [ 'slug_en' =>  $post->slug_en] ) }}" class="read-btn">Read More <span><i class="fas fa-angle-right"></i></span></a>
