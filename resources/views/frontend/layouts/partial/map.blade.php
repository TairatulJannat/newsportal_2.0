...
<div class="homePageSideSvg" style="width: 90%; margin: 0 auto;">
    ...
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'rangpur')
            <a href="{{ route('frontend.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
...
<form action="{{ route('frontend.post.getPostByLocation') }}" method ="post">
    @csrf
    <div class =" row" >
    ...
    <div class =" row">
         <div class = "col-sm-6 col-6"style ="margin:auto;">
             <select  style ="width:100%;margin-bottom:20px" name = "sub_district" class="form-select form-select-sm" value = "" id="subdistrict" >
                 <option value="" selected disabled>Sub District</option>
                 
             </select>
         </div>
         <div class = "col-sm-6 col-6" style ="margin:auto;">
            <button class ="btn btn-outline-info" style ="width:100%; margin-bottom:20px; padding: .1rem 0"><i class="fas fa-search"></i> Search</button>
