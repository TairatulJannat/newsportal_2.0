    ...
    <div class="container middle-section">
        <div class="about-page">
            <div class="content">
                ...
                <div class="details">
                    <div class="title">
                        <h1><span>{{ $page_detail->page_title_en }}</span></h1>
                    </div>
                    <div class="desc">
                            {{-- <center>
                                <h1>{{ $page_detail->page_title_en }}</h1>
                            </center> --}}
                        
                            <p>@isset($page_detail->description_title_en){!! $page_detail->description_title_en !!}@endisset</p> 
                    </div>
                </div>
            </div>
        </div>
