    ...
    <div class="container">
        <div class="middle-section">
            ...
            <div class = "row archive">
                <div class = "col-md-12" >
                    <form action="{{ route ('frontend.archive.filterNews')}}" method = "GET">
                        <div class="row">
                        ...
                        <div class="box-ashes">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-sm-6">
                                    <a href="{{ route('frontend.archive.index') }}" class="btn btn-danger btn-block">সব সংবাদ খুজুন</a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="archive-details">
                                    <div class="title">
                                        <a href="{{ route('frontend.post.SinglePostByDivision' , ['slug_en' =>  $post->slug_en] ) }}">
                                            <h2>{{$post->title_en}}  </h2>
                                        </a>
                                    </div>
                                    <div class="date"><p>{{\Carbon\Carbon::parse($post->published_date)->isoFormat('dddd, MMM Do YYYY')}}</p></div>
                                </div>
