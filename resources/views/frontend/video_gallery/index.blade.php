                ...
                <div class="main-video">
                    <div class="title-bottom">
                        <div class="post-author">
                            <span class="post-author-name">{{ $video->user->name_en }}</span>
                            <span class="post-date">{{\Carbon\Carbon::parse($video->created_at)->isoFormat('dddd, MMM Do YYYY')  }}</span>
                        </div>
                            ...
                            <li>
                                <div class="news-cards-wrapper d-flex justify-content-between">
                                    <div class="news-card video-news">
                                        <a href="{{route('frontend.vediogallery',$video->video_title_en)}}">
                                            <div class="vid">
                                            ...
                                            <p class="news-title">{{ $video->video_title_en }}</p>   
                                        </a>
                                    </div>
                                </div>
                            </li>
