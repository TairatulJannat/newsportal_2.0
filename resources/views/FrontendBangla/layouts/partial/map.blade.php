...
<!-- {{$divisions}} -->
<div class="homePageSideSvg" style="width: 90%; margin: 0 auto;">
    ...
    <style type="text/css">
        ...
        .st1{fill:#80C2EB;}
        .st2{fill:none;}
        .st3{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st4{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st5{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st6{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st7{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st8{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st9{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st10{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st11{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}

        .st13{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.25;stroke-miterlimit:10;}
        .st14{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
        .st15{fill:#fb2727;stroke:#FFFFFF;stroke-width:0.25;stroke-miterlimit:10;}
        .st16{enable-background:new    ;}
        .st17{fill:#FFFFFF;}
        .st18{opacity:0.34;}
        .st19{fill:#D5D5D5;}

        #rangpur:hover path{fill:#2f8439;}
        #rangpur:hover path.st17{fill:#fff;}
        #rangpur:hover path.st19{fill:#d5d5d5;}

        #mymensingh:hover path{fill:#2f8439;}
        #mymensingh:hover path.st17{fill:#fff;}
        #mymensingh:hover path.st19{fill:#d5d5d5;}

        #sylhet:hover path{fill: #2f8439;}
        #sylhet:hover path.st17{fill:#fff;}
        #sylhet:hover path.st19{fill:#d5d5d5;}

        #rajshahi:hover path{fill: #2f8439;}
        #rajshahi:hover path.st17{fill:#fff;}
        #rajshahi:hover path.st19{fill:#d5d5d5;}

        #khulna:hover path{fill: #2f8439;}
        #khulna:hover path.st17{fill:#fff;}
        #khulna:hover path.st19{fill:#d5d5d5;}

        #borishal:hover path{fill: #2f8439;}
        #borishal:hover path.st17{fill:#fff;}
        #borishal:hover path.st19{fill:#d5d5d5;}

        #chittagong:hover path{fill: #2f8439;}
        #chittagong:hover path.st17{fill:#fff;}
        #chittagong:hover path.st19{fill:#d5d5d5;}

        #dhaka:hover path{fill: #2f8439;}
    ...
    <!-- xlink:href=https://www.jagonews24.com/bangladesh/rangpur -->
    <g id="rangpur">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'rangpur')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
    ...
    <g id="sylhet">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'sylhet')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
    ...
    <g id="khulna">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'khulna')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
    ...
    <g id="dhaka">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'dhaka')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach	
    ...
    <g id="mymensingh">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'mymensingh')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach	
    ...
    <g id="rajshahi">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'rajshahi')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
    ...
    <g id="borishal">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'borishal')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
    ...
    <g id="chittagong">
    @foreach($divisions as $division)
        @if(strtolower($division->division_name_en) == 'chittagong')
            <a href="{{ route('FrontendBangla.post.postByDivision' , $division->division_slug_en ) }}" >
        @endif
    @endforeach
...
<form action="{{ route('FrontendBangla.post.getPostByLocation') }}" method ="post">
    @csrf
    <div class =" row" >
            <div class = "col-sm-6 col-6" style ="margin:auto;" >      
                <select style ="width:100%;margin-bottom:20px " name = "division" class="form-select form-select-sm " id="division">
                    <option value="" selected disabled>বিভাগ</option>
                    @foreach($divisions as $division)
                        <option value="{{ $division->id }}">{{ $division->division_name_en }} || {{ $division->division_name_bn }} </option>
                    @endforeach
                </select>
            </div>
            
            <div class = "col-sm-6 col-6" style ="margin:auto;" >
                <select style =" width:100%;margin-bottom:20px" name = "district" class="form-select form-select-sm"  value = ""id="district">
    ...
    <div class =" row">
         <div class = "col-sm-6 col-6"style ="margin:auto;">
             <select  style ="width:100%;margin-bottom:20px" name = "sub_district" class="form-select form-select-sm" value = "" id="subdistrict" >
                 <option value="" selected disabled>উপজেলা</option>
                 
             </select>
         </div>
         <div class = "col-sm-6 col-6" style ="margin:auto;">
            <button class ="btn btn-outline-info" style ="width:100%; margin-bottom:20px; padding: .1rem 0"><i class="fas fa-search"></i> সন্ধান করুন
            </button>
             {{-- <input style ="width:100%;margin-bottom:20px"type="submit"class ="btn btn-outline-info" value ="search"> --}}
         </div>
    </div>
 </form>
 @push('js')
