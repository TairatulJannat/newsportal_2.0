                                    ...
                                    <td>
                                        <div class="togglebutton">
                                            ...
                                            @foreach ( $advertisements as $advertisement)
                                                @if ( $advertisement->position == 'bellow_recent_news')
                ...
                @foreach ($advertisements as $advertisement)
                    @if ($advertisement->position == 'bellow_recent_news')
                        <form action="{{ route('admin.ads.store') }}" class="form-horizontal" method="post" id="" enctype="multipart/form-data" accept-charset="utf-8">
                            @csrf
                            <input type="hidden" name="position" value="bellow_recent_news"> 
                            ...
                            <div class="panel-body">
                                <div class="form-group margin-top-10">
                                    <div class="form-group">
                                        ...
                                        @if($advertisement !== null && $advertisement->position == 'bellow_recent_news')
