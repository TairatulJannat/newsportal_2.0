                                    ...
                                    <td>
                                        <div class="togglebutton">
                                            ...
                                            @foreach ( $advertisements as $advertisement)
                                                @if ( $advertisement->position == 'bottom_feature_vedio')
                ...
                @foreach ($advertisements as $advertisement)
                    @if ($advertisement->position == 'bottom_feature_vedio')
                        <form action="{{ route('admin.ads.store') }}" class="form-horizontal" method="post" id="" enctype="multipart/form-data" accept-charset="utf-8">
                            @csrf
                            <input type="hidden" name="position" value="bottom_feature_vedio"> 
                            ...
                            <div class="panel-body">
                                <div class="form-group margin-top-10">
                                    <div class="form-group">
                                        ...
                                        @if($advertisement !== null && $advertisement->position == 'bottom_feature_vedio')
