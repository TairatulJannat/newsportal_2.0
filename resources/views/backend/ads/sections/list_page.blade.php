                                    ...
                                    <td>
                                        <div class="togglebutton">
                                            ...
                                            @foreach ( $advertisements as $advertisement)
                                                @if ( $advertisement->position == 'bellow_list_news')
                ...
                @foreach ($advertisements as $advertisement)
                    @if ($advertisement->position == 'bellow_list_news')
                        <form action="{{ route('admin.ads.store') }}" class="form-horizontal" method="post" id="" enctype="multipart/form-data" accept-charset="utf-8">
                            @csrf
                            <input type="hidden" name="position" value="bellow_list_news"> 
                            <input type="hidden" name="page_name" value="list_page">                                                                                            
                            <div class="panel-body">
                                <div class="form-group margin-top-10">
                                    <div class="form-group">
                                        <label for="exampleEmail" class="md-label-floating">Redirect Url </label>
                                        @if($advertisement !== null && $advertisement->position == 'bellow_list_news')
                                            <input type="text" class="form-control" name="redirect_url" id="redirect_url" value = "{{ $advertisement->ads_link }}">
                                        @else
