                        ...
                        <table class="table table-hover"   >
                            <tbody>
                                <tr>
                                    <td>Position</td>
                                    <td>:</td>
                                    <td>Above Related News Section</td>
                                </tr>
                                <tr>
                                    <td>Page</td>
                                    <td>:</td>
                                    ...
                                    <td>
                                        <div class="togglebutton">
                                            ...
                                            @foreach ( $advertisements as $advertisement)
                                                @if ( $advertisement->position == 'above_related_post')
                ...
                @foreach ($advertisements as $advertisement)
                    @if ($advertisement->position == 'above_related_post')
                        <form action="{{ route('admin.ads.store') }}" class="form-horizontal" method="post" id="" enctype="multipart/form-data" accept-charset="utf-8">
                            @csrf
                            <input type="hidden" name="position" value="above_related_post"> 
                            <input type="hidden" name="page_name" value="detail_page">                                                                                            
                            <div class="panel-body">
                                <div class="form-group margin-top-10">
                                    <div class="form-group">
                                        <label for="exampleEmail" class="md-label-floating">Redirect Url </label>
                                        @if($advertisement !== null && $advertisement->position == 'above_related_post')
