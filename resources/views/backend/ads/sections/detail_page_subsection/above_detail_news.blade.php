                        ...
                        <table class="table table-hover"   >
                            <tbody>
                                <tr>
                                    <td>Position</td>
                                    <td>:</td>
                                    <td>Above Detail News Section</td>
                                </tr>
                                <tr>
                                    <td>Page</td>
                                    <td>:</td>
                                    ...
                                    <td>
                                        <div class="togglebutton">
                                            ...
                                            @foreach ( $advertisements as $advertisement)
                                                @if ( $advertisement->position == 'above_single_post')
                ...
                @foreach ($advertisements as $advertisement)
                    @if ($advertisement->position == 'above_single_post')
                        <form action="{{ route('admin.ads.store') }}" class="form-horizontal" method="post" id="" enctype="multipart/form-data" accept-charset="utf-8">
                            @csrf
                            <input type="hidden" name="position" value="above_single_post"> 
                            ...
                            <div class="panel-body">
                                <div class="form-group margin-top-10">
                                    <div class="form-group">
                                        ...
                                        @if($advertisement !== null && $advertisement->position == 'above_single_post')
